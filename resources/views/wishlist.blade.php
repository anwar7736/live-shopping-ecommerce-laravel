            ...
            <div class="container mt-5 mb-5">
                ...
                @for($i = 0; $i < 2; $i++)
                    <div class="col-lg-12 col-md-6 col-12 product wishlist-product p-2 d-lg-flex">
                        ...
                        <div class="images">
                            <a href="{{route('product.details', ['id'=>$id ?? 1])}}">
                        ...
                        <div class="product-details text-start pt-2 ps-4">
                            ...
                            <a href="{{route('product.details', ['id'=>$id ?? 1])}}" class="text-dark" style="text-decoration: none; font-weight: 600;">Exclusive Mens Polo Shirts</a>
                            <div class="price">
